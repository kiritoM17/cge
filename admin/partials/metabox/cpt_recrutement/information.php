...
<table class="form-table">
    <tbody>
        ...
        <tr class="form-field">
            ...
            <td><input id="date_debut_emplois" type="date" name="Recrutement[date_debut_emplois]" value="<?php echo isset($data[$this->meta_prefix . 'date_debut_emplois'][0]) ?  date('Y-m-d', strtotime($data[$this->meta_prefix . 'date_debut_emplois'][0])) : null; ?>"></td>
        </tr>
        <tr class="form-field">
            <th scope="row">
                <label for="date_depot_emplois" class="box-label"><?php echo __('Date de depot emplois :', 'cge'); ?></label>
            </th>
            <td><input id="date_depot_emplois" type="date" name="Recrutement[date_depot_emplois]" value="<?php echo isset($data[$this->meta_prefix . 'date_depot_emplois'][0]) ? date('Y-m-d', strtotime($data[$this->meta_prefix . 'date_depot_emplois'][0])) : null; ?>"></td>
        </tr>
    </tbody>
</table>
<br>