    ...
    <tr>
        <td>
            <table class="form-table">
                <?php
                $dataCoAccrediteurs = ( isset($data[$this->meta_prefix . '_ecole_associations']) && strlen($data[$this->meta_prefix . '_ecole_associations'][0]) > 0 ) ? unserialize($data[$this->meta_prefix . '_ecole_associations'][0]) : [];
