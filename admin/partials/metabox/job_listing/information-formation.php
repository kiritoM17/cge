    ...
    <tr>
        <td>
            <table class="form-table">
                <?php
                $dataCoAccrediteurs = ( isset($data[$this->meta_prefix . '_ecole_resp_formation']) && strlen($data[$this->meta_prefix . '_ecole_resp_formation'][0]) > 0 ) ? unserialize($data[$this->meta_prefix . '_ecole_resp_formation'][0]) : [];
