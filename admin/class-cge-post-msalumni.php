...
class CGE_Msalumni
{
     ...
     * @var string
     */
    protected $meta_prefix = '_msalumni_field';
        /**
     * @var string
     */
    ...
    protected function __construct() {
        ...
        $this->singular_form_label = __('msalumni', 'cge');
        $this->singular_form_label_lowercase = __('form', 'cge');
        $this->plural_form_label = __('msalumni', 'cge');
        $this->plural_form_label_lowercase = __('msalumni', 'cge');
    ...
    public function init() {
        ...
        // $this->taxonomyLabels = [
        //     'menu_name' => __('Categories', 'e-torisme'),
        //     'name' => sprintf(__('%s Category', 'e-torisme'), $this->singular_form_label),
        //     'singular_name' => sprintf(__('%s Category', 'e-torisme'), $this->singular_form_label),
        //     'search_items' => sprintf(__('Search %s Categories', 'e-torisme'), $this->singular_form_label),
        //     'all_items' => sprintf(__('All %s Categories', 'e-torisme'), $this->singular_form_label),
        //     'parent_item' => sprintf(__('Parent %s Category', 'e-torisme'), $this->singular_form_label),
        //     'parent_item_colon' => sprintf(__('Parent %s Category:', 'e-torisme'), $this->singular_form_label),
        //     'edit_item' => sprintf(__('Edit %s Category', 'e-torisme'), $this->singular_form_label),
        //     'update_item' => sprintf(__('Update %s Category', 'e-torisme'), $this->singular_form_label),
        //     'add_new_item' => sprintf(__('Add New %s Category', 'e-torisme'), $this->singular_form_label),
        //     'new_item_name' => sprintf(__('New %s Category Name', 'e-torisme'), $this->singular_form_label),
        //     'item_link' => sprintf(__('%s Category Link', 'e-torisme'), $this->singular_form_label),
        //     'item_link_description' => sprintf(__('A link to a particular %s category.', 'e-torisme'), $this->singular_form_label),
        // ];
