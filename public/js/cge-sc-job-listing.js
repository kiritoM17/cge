            ...
            htmlResult +=`
                <div class="row-content">
                    <div class="logo-ecole">
                        <div class="grid-style1" itemscope itemtype="http://schema.org/LocalBusiness" data-longitude="${item.post_meta.geolocation_long[0] != ""? item.post_meta.geolocation_long[0] : ""}" data-latitude="${ item.post_meta.geolocation_lat[0] !="" ? item.post_meta.geolocation_lat[0] : "" }" data-img="${ item.post_meta._ecole_logo[0] != "" ? item.post_meta._ecole_logo[0] : ""}">  
                            <div class="listing-image">
                                <div class="image-wrapper">
                                    <a href="#">
                                        <img src="${item.post_meta._ecole_logo[0] != "" ? item.post_meta._ecole_logo[0]: ""}" data-src="${item.post_meta._ecole_logo[0] != "" ? item.post_meta._ecole_logo[0]: ""}" alt="" class="unveil-image">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="detail-ecole">
                        <div class="listing-title-wrapper">
                            ...
                            <ul>
                                <li>
                                    ${item.post_meta._ecole_annee_creation[0] != "" ? item.post_meta._ecole_annee_creation[0]: ""}
                                </li>
                                <li>
                                    ${item.post_meta._ecole_statut[0] != "" ? item.post_meta._ecole_statut[0]: ""}
                                </li>
                                <li>
                                    ${item.post_meta._ecole_type_formation[0] != "" ? item.post_meta._ecole_type_formation[0]: ""}
                                </li>
                            </ul>
                        </div>
                    </div>
